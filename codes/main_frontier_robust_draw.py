...
robust_actual_directory = os.path.join(project_directory, folder_name, file_name_robust_actual)
robust_estimated_directory = os.path.join(project_directory, folder_name, file_name_robust_estimated)
